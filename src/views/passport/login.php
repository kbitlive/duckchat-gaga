            ...
            <div class="zaly_login zaly_login_by_pwd" >
                <div class="login_input_div" >
                    ...
                    <div class=" d-flex flex-row justify-content-left login_name_div" >
                        ...
                        <div class="clearLoginName" onclick="clearLoginName()"><image src="../../public/img/msg/btn-x.png" class="clearLoginName" style="width: 2rem;height:2rem;cursor: pointer;"/></div>
