...
<script id="tpl-group-member-info" type="text/html">
    ...
    {{if isSelf == false}}
        ...
        {{else relation != "FriendRelationFollow" && isCanAddFriend }}
